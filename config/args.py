...
def setting_args():
    ...
    parser.add_argument('--root_dir',default='/home/sky/PycharmProjects/data/Video',
        type=str, help='The dir for orig video dir')
    parser.add_argument('--pic_dir', default='/home/sky/PycharmProjects/data/Pic',
        type=str, help='The pic of video frames')
    parser.add_argument('--label_dir',default='/home/sky/PycharmProjects/data/label',
